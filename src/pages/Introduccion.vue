...
.curso-main-container.introduccion
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    p.mb-5(data-aos='fade-right') ¡Le invitamos a explorar el mundo de la programación orientada a objetos, donde descubrirá cómo crear software robusto y flexible, aplicando principios y patrones que han resistido la prueba del tiempo!
    figure
      .video
